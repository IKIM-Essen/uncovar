...
def eval_kallisto_error(kallisto_tsvs, sm_output, max_reads, prefix, separator, percentage):
...
def eval_pangolin_error(pangolin_csvs, sm_output, max_reads, prefix, separator, percentage):
    results_df = pd.DataFrame()
