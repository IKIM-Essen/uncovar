...
def plot_pangolin_conflict(sm_input, sm_output):
    ...
    for input in sm_input:
        ...
        true_lineage, percent = true_lineage_with_percent.split(MIXTURE_PERCENTAGE_INDICATOR)
    ...
    all_sampes["correct_lineage_assignment"] = all_sampes["lineage"] == all_sampes["true_lineage"]

    print(
        all_sampes["correct_lineage_assignment"].value_counts(normalize=True), file=sys.stderr
    )
